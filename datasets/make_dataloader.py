...
from .vnpt1 import VNPT1
from .unified_reid import UnifiedReID
__factory = {
...
def make_dataloader(cfg):
    ...
    elif cfg.DATASETS.NAMES == 'unified_reid':
        subsets_str = cfg.DATASETS.TRAIN_SUBSETS.strip()
        subsets = [s.strip() for s in subsets_str.split(',') if s.strip()] if subsets_str else None
        dataset = __factory['unified_reid'](root=cfg.DATASETS.ROOT_DIR, subsets=subsets)
    else:
